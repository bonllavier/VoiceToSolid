...
CREATE TABLE `tbl_pieces` (
  ...
  CONSTRAINT `color_id` FOREIGN KEY (`color_id`) REFERENCES `tbl_colors` (`color_id`) ON DELETE CASCADE,
  CONSTRAINT `project_id` FOREIGN KEY (`project_id`) REFERENCES `tbl_projects` (`project_id`) ON DELETE CASCADE,
  CONSTRAINT `shape_id` FOREIGN KEY (`shape_id`) REFERENCES `tbl_shapes` (`shape_id`) ON DELETE CASCADE
